...
class AnalisisVentaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $ventas = $this->consultarVentasSAP($request);
    
        // Pasamos los datos de ventas a la vista 'index' en forma de variable
        return view('AnalisisVentas.index', compact('ventas'));
    }
    

    public function consultarVentasSAP(Request $request)
    {
        ...
        $ventasUrl = $sapBaseUrl . "/sml.svc/ANALISIS_VENTA?\$select=CardCode,CardName,ValorIva,ValorTotal,DocNum,Kg_Vendidos,TipoDoc,DocDate,DocDueDate,Centro_Operaciones,Centro_Costo&\$filter=DocDate ge '$start_date' and DocDate le '$end_date' and Centro_Costo eq 'FRM'";
