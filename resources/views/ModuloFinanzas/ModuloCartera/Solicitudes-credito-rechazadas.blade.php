        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header" style="background-color: #1c2a48;">
                    ...
                    <div class="container">
                        <header class="py-2" style="text-align: center; ">
                            <h4><b style="color: #fff;">Solicitudes de crédito Rechazadas</b></h4>
                        </header>
                    ...
                    <ul class="nav nav-tabs" id="myTabs">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{url('Solicitudes-creditos')}}">Nuevas Solicitudes
                                </a>
                ...
                <table class="table table-bordered table-striped" id="datatableinfo">
                    ...
                    <tbody>
                        @foreach($soliRechazadas as $credito)
                        <tr>
                            ...
                            <td class="timeline-cell" style="font-size: 12px;">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content" style="font-size: 12px;">Aprobación Beratung</div>
                                </div>
                                <div class="timeline-item">
                            ...
                            <td style="font-size: 12px;">
                                ...
                                @if (auth()->check() && auth()->user()->hasRole('Gerencia'))
                                @if ($credito->Estado_Gerencia === 'Pendiente')
                                ...
                                @if (auth()->check() && auth()->user()->hasRole('Gerencia'))
                                @if ($credito->Estado_Gerencia === 'Pendiente')
                                <button type="button" class="btn btn-sm btn-danger" onclick="rechazargerencia({{ $credito->id }})">
                                    <i class="fas fa-times"></i>
                                </button>
                                ...
                                <button type="button" class="btn btn-outline-secondary" data-toggle="modal" data-target="#comentarioModal{{ $credito->id }}" data-solicitud-id="{{ $credito->id }}">
                                    <i class="fas fa-comment"></i>
                                </button>

                                <button type="button" class="btn btn-outline-info" onclick="verComentarios({{ $credito->id }})">
                                    <i class="fas fa-eye"></i>
                                </button>


                                <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#editarModal{{ $credito->id }}">

                                    <i class="fas fa-edit"></i>
                                </button>


                                <button type="button" data-toggle="modal" data-target="#adjuntoscartera{{ $credito->id }}" class="btn btn-outline-secondary">
