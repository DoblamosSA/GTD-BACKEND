...
<style>
    .selected-row {
    background-color: #B8B6B4; /* Cambia el color según tus preferencias */
}
</style>
                ...
                <div class="card-header" style="background-color: #1c2a48;">
                    ...
                    <div class="container">
                        <header class="py-2" style="text-align: center; ">
                            <h4><b style="color: #fff;">MRP ALMACÉN SAP</b></h4>
                        </header>
                            ...
                            <table id="datatable" class="table" style="width: 100%;">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: 10px; width: 10%;">P.CONSUMO</th>
                                ...
                                <tbody>
                                    @foreach($abastecimientoalmacen as $abastecimiento)
        ...
        document.getElementById("btnGenerarpromedioventa").addEventListener("click", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Obtener valores modificados de Sugerido
                    var sugeridos = document.querySelectorAll('input[name="sugerido[]"]');
                    var sugeridoValues = Array.from(sugeridos).map(input => input.value);

                    // Realizar la solicitud fetch con el método POST y parámetros en el cuerpo
                    fetch('https://rdpd.sagerp.co:59881/gestioncalidad/public/api/consumirpromedioventaSAPAlmacen', {
                            method: 'POST',
                            headers: {
        ...
        document.getElementById("btnGenerarSolicitudCompra").addEventListener("click", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // Realizar la solicitud fetch con el método POST y parámetros en el cuerpo
                    fetch('https://rdpd.sagerp.co:59881/gestioncalidad/public/api/generar-solicitud-compra-almacen', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '{{ csrf_token() }}', // Agregar token CSRF si es necesario
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        $('#datatable tbody').on('click', '.article-link', function(e) {
            ...
            $.ajax({
                url: 'https://rdpd.sagerp.co:59881/gestioncalidad/public/api/consultar-stock-bodega-articuloSAP-Almacen', // Asegúrate de actualizar la URL
                ...
                success: function(response) {
                    ...
                    itemStock.forEach(function(warehouseInfo) {
                        ...
                        responseTable.append('<tr><td>' + warehouseCode + '</td><td>' + inStock + '</td><td>' + Ordered + '</td><td>' + Committed + '</td><td>' + disponible + '</td></tr>');
