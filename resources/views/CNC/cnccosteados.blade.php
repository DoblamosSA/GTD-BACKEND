        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="col">
                    ...
                    <form id="searchForm" action="{{ url('CNC-COSTEADOS') }}" method="GET">
                        <div class="btn-group">
                            <div class="col-md-6 ">
                ...
                <table class="table table-bordered table-striped" id="datatableinfo">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px; background-color: @if($costonocalidad->EstadoCNC == 'No Costeado') #934E4B @elseif($costonocalidad->EstadoCNC == 'Costeado') #B3F295 @endif; color: white;">
                                <b>
