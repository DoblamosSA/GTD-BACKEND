        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{ route('Laminas.update',$lamina->id) }}">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="descripcion" id="descripcion" class="form-control"
                                required>{{ $lamina->Descripcion }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div id="calibres">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select name="calibres[]" class="form-control" required>
                                        ...
                                        <option value="{{ $c->id }}" {{ $calibre->id == $c->id ? 'selected' : '' }}>
                                            {{ $c->Calibre }}</option>
                                        @endforeach
                                    </select>
                                    <input type="number" name="precios[]" class="form-control" required
                                        placeholder="Ingrese el precio por kilo" value="{{ $calibre->pivot->precio }}">
...
$(function() {
  $('.add-calibre').click(function() {
    var html = '<div class="input-group mb-3">' +
      ...
      '<button class="btn btn-danger remove-calibre" type="button">Eliminar</button>' +
