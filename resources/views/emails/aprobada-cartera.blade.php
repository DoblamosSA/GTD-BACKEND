...
<head>
    ...
    <title>Solicitud de Crédito aprobada cartera Doblamos</title>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td class="header"
                ...
                <h2 style="font-family: Arial, sans-serif; font-size: 28px;">Solicitud de Crédito aprobada cartera Doblamos</h2>
                <!-- Icono de rechazo -->
            </td>
        </tr>
        ...
        <tr>
            <td>
                ...
                <p>Le informamos que después de hacer el análisis y estudio de los documentos el cliente cumple.</p>
                <p>Continuar con el proceso.</p>
                
                <p>Cordialmente,</p>
                <p class="signature">Departamento de cartera de Doblamos</p>
            </td>
        </tr>
        <tr>
            <td class="footer">
