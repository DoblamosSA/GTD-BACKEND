    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
            <td class="header">
                ...
                <h2 style="font-family: Arial, sans-serif; font-size: 28px;"> Solicitud de Crédito rechazada por gerencia</h2>
            </td>
        ...
        <tr>
            <td>
                ...
                <p>Se rechaza la solicitud de credito:</p>
                <div class="highlight">
                    <ul>
                ...
                <p>Se reviso la solicitud de crédito y se rechaza, por favor dar el rechazado final en cartera.</p>
