...
<head>
    ...
    <title>Solicitud de Crédito Aprobada por sagrilaf</title>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td class="header"
                ...
                <h2 style="font-family: Arial, sans-serif; font-size: 28px;">Solicitud de Crédito aprobada por sagrilaf</h2>
                <!-- Icono de rechazo -->
            </td>
        </tr>
        ...
        <tr>
            <td>
                <p>Señores,</p>
                <p><strong>Cartera Doblamos</strong></p>
