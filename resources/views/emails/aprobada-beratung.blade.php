...
<head>
    ...
    <title>Solicitud de Crédito aprobada por beratung</title>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td class="header"
                ...
                <h2 style="font-family: Arial, sans-serif; font-size: 28px;">Solicitud de Crédito aprobada por beratung</h2>
                <!-- Icono de rechazo -->
            </td>
        </tr>
