...
class CreateSolicitudesCompraHistorialeAlmacenesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('solicitudes_compra_historiale_almacenes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('solicitudes_compra_historiale_almacenes');
    }
}
